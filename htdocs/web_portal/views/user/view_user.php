...
<div class="rightPageContainer">
    ...
    <div style="float: left; width: 100%; margin-top: 2em;">
         <div class="alert alert-warning" role="alert">
            <ul>
              ...
              <li>Personal data, which you provide and is collected when you use GOCDB,
                        ...
                        <td class="site_table">
                            <form action="index.php?Page_Type=Remove_User_Identifier&amp;id=
                                ...
                                <div class="btn-like"
                                    ...
                                    ?>
                                    <?php
                                    if ($params['currentIdString'] === $identifier->getKeyValue()) {
                                        echo "title='Cannot remove the identifier you are using'";
                                    }
                                    ?>
                                >
                                <input id="revokeButton" type="submit" value="Remove" class="btn btn-sm btn-danger"
                                    ...
                                    <?php
                                    if (
                                        $params['lastIdentifier']
                                        || $params['currentIdString'] === $identifier->getKeyValue()
                                    ) {
                                        echo "disabled";
                                    }
                                    ?>
    ...
    <div style="float: left; width: 100%; margin-top: 2em;" class="alert alert-info" role="alert">
        See the <a href="index.php?Page_Type=View_Role_Action_Mappings">role action mappings</a>
        page to see which permissions are granted by which roles.
    </div>

    <!-- Roles per Project -->
    <?php
    foreach ($params['projectNamesIds'] as $projId => $projName) {?>
            ...
            foreach ($params['role_ProjIds'] as $role_ProjIds) { // foreach role
                ...
                if (in_array($projId, $projIds)) { // if projId in array
                    ...
                    if ($role->getOwnedEntity() instanceof \Site) {?>
                        <a style="vertical-align: middle;" href="index.php?Page_Type=Site&id=
                            <?php echo $role->getOwnedEntity()->getId()?>">
                    ...
                    if ($role->getOwnedEntity() instanceof \NGI) {?>
                        <a style="vertical-align: middle;" href="index.php?Page_Type=NGI&id=
                            <?php echo $role->getOwnedEntity()->getId()?>">
                    ...
                    if ($role->getOwnedEntity() instanceof \ServiceGroup) {?>
                        <a style="vertical-align: middle;" href="index.php?Page_Type=Service_Group&id=
                            <?php echo $role->getOwnedEntity()->getId()?>">
                    ...
                    if ($role->getOwnedEntity() instanceof \Project) {?>
                       <a style="vertical-align: middle;" href="index.php?Page_Type=Project&id=
                        <?php echo $role->getOwnedEntity()->getId()?>">
                    ...
                    <?php
                    if (
                        !$params['portalIsReadOnly']
                        && is_array($decorator)
                        && $decorator["revokeButton"] == 'disabled'
                    ) {
                        echo 'Remove or reassign API credentials from site(s) before revoking this role. Sites: ' .
                                $decorator["revokeMessage"];
                    }
                    ?>
                    </td>
                    </tr>
            ...
            <table style="clear: both; width: 100%;">
                ...
                foreach ($params['APIAuthEnts'] as $APIAuthEnt) { ?>
                    <tr>
                        ...
                        <td class="site_table">
                            <a href="index.php?Page_Type=Site&amp;id=
                                <?php xecho($APIAuthEnt->getParentSite()->getId())?>"
